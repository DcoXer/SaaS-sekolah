                        ...
                        <div v-for="classroom in rooms" :key="classroom.id" class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                            <div class="p-4">
                                ...
                                <div class="mt-2 flex flex-wrap items-center gap-1.5">
                                    ...
                                    <template v-else>
                                        <span v-if="getStats(classroom.id).approved > 0" class="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2 py-0.5 text-xs font-semibold text-emerald-700">
