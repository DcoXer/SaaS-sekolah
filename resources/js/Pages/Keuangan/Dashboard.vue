...
const quickActions = [
    { label: 'Tagihan Siswa',  href: '/keuangan/invoices',      bg: 'bg-primary-50 group-hover:bg-primary-100', text: 'text-primary-600', icon: 'M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z' },
    { label: 'Tagihan PPDB',   href: '/keuangan/ppdb-invoices', bg: 'bg-sky-50 group-hover:bg-sky-100',         text: 'text-sky-600',     icon: 'M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z' },
...
<template>
    <AppLayout>
        ...
        <div class="space-y-6">
            ...
            <!-- Welcome banner -->
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-600 via-primary-500 to-teal-500 p-6 text-white shadow-lg">
                ...
                <div class="pointer-events-none absolute left-1/3 -top-4 size-28 rounded-full bg-primary-300/20 blur-xl" />
                ...
                <div class="relative flex items-start gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm text-primary-100">{{ greeting }},</p>
                        ...
                        <div class="mt-1.5 flex flex-wrap gap-2">
                            ...
                            <span v-if="activeYear" class="inline-flex items-center rounded-full bg-white/15 px-2.5 py-0.5 text-xs font-medium text-primary-100 backdrop-blur-sm">
                                {{ activeYear.name }}
                            </span>
                        </div>
                    </div>
                ...
                <div class="relative mt-5 grid grid-cols-3 gap-2">
                    <div class="rounded-xl bg-white/15 p-3 text-center backdrop-blur-sm">
                        ...
                        <p class="mt-0.5 text-xs text-primary-100">Total Tagihan</p>
                    </div>
                    <div class="rounded-xl bg-white/15 p-3 text-center backdrop-blur-sm">
                        <p class="tabular-nums text-2xl font-extrabold">{{ stats.paid ?? 0 }}</p>
                        <p class="mt-0.5 text-xs text-primary-100">Lunas</p>
                    </div>
                    <div class="rounded-xl bg-white/15 p-3 text-center backdrop-blur-sm">
                        <p class="tabular-nums text-2xl font-extrabold">{{ (stats.unpaid ?? 0) + (stats.partial ?? 0) }}</p>
                        <p class="mt-0.5 text-xs text-primary-100">Belum Lunas</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
                ...
                <div class="rounded-2xl border border-primary-100 bg-primary-50 p-4 shadow-sm">
                    <p class="text-xs font-semibold uppercase tracking-wide text-primary-500">Lunas</p>
                    <p class="tabular-nums mt-1.5 text-3xl font-extrabold text-primary-700">{{ stats.paid ?? 0 }}</p>
                    <p class="mt-0.5 text-xs text-primary-400">tagihan</p>
                </div>
            ...
            <div class="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
                <div class="mb-4 flex items-center gap-3">
                    <div class="flex size-10 shrink-0 items-center justify-center rounded-xl bg-primary-50">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    <select
                        ...
                        class="flex-1 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700 focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100"
                    >
                    ...
                    <button
                        ...
                        class="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-primary-500 to-teal-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:from-primary-600 hover:to-teal-600 disabled:cursor-not-allowed disabled:opacity-50"
                    >
            ...
            <div class="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm">
                <div class="flex items-center justify-between border-b border-slate-50 px-5 py-4">
                    ...
                    <Link href="/keuangan/invoices" class="text-xs font-semibold text-primary-600 hover:text-primary-700">
                        Lihat semua →
                    </Link>
                </div>
                ...
                <div v-else class="divide-y divide-slate-50">
                    ...
                    >
                        <div class="flex size-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-primary-400 to-teal-500 text-xs font-bold text-white shadow-sm">
