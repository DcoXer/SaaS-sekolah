...
// Preview: pakai existing image dari server jika ada, null jika tidak
const imagePreview = ref(
    props.extracurricular.image ? `/storage/${props.extracurricular.image}` : null
);
...
<template>
    <AppLayout>
        <Head :title="`Edit Ekskul — ${extracurricular.name}`" />
        ...
        <template #title>
            <div class="flex items-center gap-2 text-sm text-slate-500">
                ...
                <span>/</span>
                <span class="font-semibold text-slate-700">Edit Ekskul</span>
            </div>
        </template>
        ...
        <div class="mx-auto max-w-2xl">
            <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                ...
                <div class="border-b border-slate-100 px-6 py-4">
                    <h2 class="text-sm font-bold text-slate-800">Edit Ekskul</h2>
                    <p class="mt-0.5 text-xs text-slate-400">Perbarui informasi ekstrakulikuler <span class="font-semibold text-slate-600">{{ extracurricular.name }}</span>.</p>
                </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="mt-1 space-y-1.5">
                                ...
                                <p v-if="extracurricular.image && !form.image" class="text-xs text-slate-400">Biarkan kosong untuk tidak mengubah foto.</p>
                            </div>
                        </div>
