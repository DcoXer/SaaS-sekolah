        ...
        <div class="space-y-5">
            ...
            <div class="flex items-center gap-2">
                ...
                <select v-model="selectedYear"
                    class="rounded-lg border border-slate-200 bg-white py-1.5 pl-3 pr-7 text-sm text-slate-700 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/20">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <div class="flex gap-1">
                            <button v-for="opt in [{ value: '', label: 'Semua' }, { value: 'guru_kelas', label: 'Guru Kelas' }, { value: 'guru_bidang', label: 'Guru Bidang' }]"
                                ...
                                :class="filterType === opt.value ? 'bg-emerald-500 text-white' : 'border border-slate-200 bg-white text-slate-600 hover:bg-slate-50'">
                                {{ opt.label }}
                            </button>
                        </div>
