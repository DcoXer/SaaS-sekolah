...
const grouped = computed(() => {
    ...
    // Urut per grade 1–6, hanya tampilkan yang ada isinya
...
const createForm = useForm({ name: '', grade: '' });
...
const editForm = useForm({ name: '', grade: '' });

const openEdit = (subject) => {
    editTarget.value = subject;
    editForm.name  = subject.name;
    editForm.grade = subject.grade;
    ...
    <AppLayout>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p class="text-pretty text-sm text-slate-500">
                        Kelola mata pelajaran per tingkat kelas (1–6).
                    </p>
                </div>
                <button
                    @click="openCreate"
            ...
            >
                ...
                <p class="mt-1 text-xs text-slate-400">Tambah mata pelajaran untuk setiap tingkat kelas.</p>
                <button
                    @click="openCreate"
                ...
                >
                    ...
                    <div class="flex items-center justify-between border-b border-slate-100 bg-slate-50 px-5 py-3">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="tabular-nums text-xs text-slate-400">{{ group.items.length }} mata pelajaran</span>
                        </div>
                    </div>
