...
<template>
    <AppLayout>
        ...
        <div class="space-y-4">
            ...
            <!-- Search & Filter -->
            <div v-if="classrooms.length > 0" class="flex flex-wrap items-center gap-2">
        ...
        <Modal :show="showCreate" max-width="sm" @close="showCreate = false">
            <form @submit.prevent="submitCreate">
                ...
                <div class="space-y-4 px-6 py-5">
                    ...
                    <!-- Tahun Ajaran -->
                    <div>
                        <label for="c-year" class="mb-1.5 block text-xs font-semibold text-slate-600">
                        ...
                        <select
                            ...
                            :class="[
                                ...
                                createForm.errors.academic_year_id ? 'border-red-400' : 'border-slate-200',
                            ]"
                        >
