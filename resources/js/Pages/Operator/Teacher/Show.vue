        ...
        <div class="mx-auto max-w-2xl space-y-5">
            ...
            <div class="flex items-center justify-between rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                <div class="flex items-center gap-4">
                    <div class="flex size-14 items-center justify-center rounded-full bg-emerald-100 text-lg font-bold text-emerald-700">
                        {{ initials(teacher.user.name) }}
                    </div>
                    <div>
                        <h2 class="text-balance text-base font-bold text-slate-900">{{ teacher.user.name }}</h2>
                        <p class="text-pretty text-sm text-slate-500">{{ teacher.user.email }}</p>
