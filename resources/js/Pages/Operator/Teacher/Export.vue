...
const doExport = () => {
    ...
    form.method = 'POST';
    form.action = route('operator.teachers.export');
...
<template>
    <AppLayout>
        ...
        <div class="mx-auto max-w-lg space-y-6">
            ...
            <div>
                <h2 class="text-lg font-bold text-slate-900">Export Data Guru</h2>
                <p class="mt-1 text-sm text-slate-500">Unduh data guru dalam format Excel atau CSV.</p>
            </div>
